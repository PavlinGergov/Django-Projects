...
from course_interviews.helpers import Applicant, GetApplicants
...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        applicants = GetApplicants(f6s_address, f6s_application_name, f6s_api_key)

        for person in applicants.get_all_applicants():
